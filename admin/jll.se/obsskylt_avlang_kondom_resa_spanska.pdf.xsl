...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://jll.se/download/18.420a58c9144917fddc91107/1394722571868/Obsskylt+avlång+kondom+resa+Spanska.pdf'"/>
    ...
    <xsl:variable name="mainlang" select="'spa'"/>
    ...
    <parallel_text xml:lang="swe" location="obsskylt_avlang_kondom_resa.pdf"/>
